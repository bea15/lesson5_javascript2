        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
               ...
               if (income <= 18550){
                 ...
                 tax = 18550 * 0.10 + (75300 - 18550) * 0.15 + (income - 75330) * 0.25;
                 taxRate = 25;
               } //end of else if
          ...
          *******************************************************************************/
               ...
               if (income <= 9275){
                 ...
                 tax = 9275 * 0.10 + (37650 - 9275) * 0.15 +
                       (75959 - 37650) * 0.25 + (income - 75950) * 0.28;
                 taxRate = 28;
               }//end of else if
...
function clearButton () {
             ...
             //This code resets the dropdown box to the "Married Jointly" filer status.
              ...
              //This code resets the dropdown box to the "Married Separetly" filer status.
